...
export default function LeafletMap({
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      // Calculate the pixel offset for the panel (shift map view up by half panel height)
      const offset = panelHeight > 0 ? panelHeight / 2 : 0;

      // Get the target point in lat/lng
